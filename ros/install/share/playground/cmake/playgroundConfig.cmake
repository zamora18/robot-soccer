...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'playground' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ecestudent/dev/lusk/ros/install/${idir}'.  Ask the maintainer 'ecestudent <ecestudent@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/ecestudent/dev/lusk/ros/install/lib;/home/ecestudent/dev/lusk/ros/devel/lib;/opt/ros/indigo/lib)
