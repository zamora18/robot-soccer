...
P.ball_radius = 0.03;
P.ball_mu = 0.05;  % coefficient of friction for ball
...
P.camera_sigma_robot_angle = 2*pi/180; % units are radians
...
P.Q_opponent = 100*diag([.001^2, .001^1, .01^2, 0.1^1, 0.1^2, 0.1^2, 1^2,1^2,(2*pi/180)^2]);
P.R_opponent = diag([P.camera_sigma_robot_position^2; P.camera_sigma_robot_position^2; P.camera_sigma_robot_angle^2]);
P.Q_ball = .001*diag([.001^2,.001^2,.01^2,.01^2, .1^2, .1^2, 10^2, 10^2]);
